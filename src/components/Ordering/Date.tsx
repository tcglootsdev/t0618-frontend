  ...
  return (
    <div className="py-5 px-10 bg-white h-screen">
      ...
      <div className="bg-[#FAF3F2] h-3/5 text-center justify-items-center mt-8 content-center">
        ...
        <button className="bg-[#A5775E] p-3 text-center text-white uppercase" onClick={()=>router.push('/ordering/Time')}>Go to next available Date</button>
      </div>
    </div>
  );
}

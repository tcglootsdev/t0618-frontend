  ...
  return (
    <section id="contact">
      <div className="container max-w-screen-xl bg-white py-12">
        ...
        <div className="bg-[#FAF6F2] w-full flex grid-flow-col">
          <img
            alt=""
            src="https://images.unsplash.com/photo-1609557927087-f9cf8e88de18?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80"
            className="aspect-square h-[290px] object-cover"
          />
          <img
            alt=""
            src="https://images.unsplash.com/photo-1609557927087-f9cf8e88de18?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80"
        ...
        <div className="bg-[#FAF6F2] w-full">
          <div className="pt-12">
            ...
            <div className="flex gap-2 place-content-center mt-8 pb-24">
              <button className="uppercase bg-[#84635C] text-white p-4">Instagram</button>
              <button className="uppercase bg-white text-[#84635C] p-4 border-solid-[#84635C]">Instagram</button>
            </div>
          </div>
        </div>
      </div>

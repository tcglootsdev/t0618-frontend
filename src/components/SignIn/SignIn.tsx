              ...
              <form>
                <div>
                  <div className="relative">
                    <input type="email" id="email" name="email" placeholder="Email" className="w-full rounded-md text-lg text-black sm:p-3 sm:mb-4 focus:border-none bg-[#E0E0E0]" required aria-describedby="email-error" />

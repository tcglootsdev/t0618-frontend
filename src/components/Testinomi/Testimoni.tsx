    ...
    <section id="contact">
      <div className="container max-w-screen-xl bg-white py-12">
        ...
        <div className="bg-[#FAF6F2] w-full">
          <div>
            <div className="text-center place-content-center pt-24">
              <img
                alt=""
            ...
            <div className="flex gap-0.5 text-green-500 justify-center pt-12 pb-8">
              <svg
                className="h-5 w-5"
                fill="yellow"
                viewBox="0 0 20 20"
        ...
        <div className="mb-12 rounded-sm bg-white">
          ...
          <div className="border p-12 place-self-center mx-72">
              <div className="flex gap-3">
                ...
                <p className="text-[#84635C] font-sans text-lg">Elecioneaa classificação</p>
              </div>
              <div>
                <div className="mt-4">
                  <p className="text-lg text-black">A few things to consider in your review</p>
                </div>
                <div className="flex gap-2 mt-3 mb-12">
                  <strong className="rounded border bg-gray-200 px-3 py-1.5 text-[10px] font-medium text-black">
                    Service Requested
                  </strong>
                  <strong className="rounded border bg-gray-200 px-3 py-1.5 text-[10px] font-medium text-black">
                    Episode #101
